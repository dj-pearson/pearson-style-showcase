...
category: CRM
tags: ['CRM', 'CRM Automation', 'RevOps', 'Sales Automation', 'Consulting', 'HubSpot', 'Salesforce']
target_keyword: CRM automation consultant
seo_title: 'How to Choose a CRM Automation Consultant: 9 Questions to Ask'
seo_description: 'A vendor-neutral guide to hiring a CRM automation consultant: the three types of provider, the nine questions that separate operators from resellers, what engagements cost, and the red flags worth walking away from.'
seo_keywords:
  [
...
excerpt: 'Most teams hire the wrong type of provider for the problem they actually have. Here are the three kinds of CRM automation consultant, the nine questions that tell you which one is in front of you, and the answers worth walking away from.'
